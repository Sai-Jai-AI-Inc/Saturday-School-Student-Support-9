...
def create_batch(file_id):
    ...
    data = {
        "file": file_id,
        "purpose": "batch"  # Set purpose to "batch"
    }
...
def retrieve_batch_results(batch_id):
    ...
    with tqdm(total=100, desc="Waiting for batch completion", bar_format="{l_bar}{bar} {n_fmt}/{total_fmt} [{elapsed}]") as pbar:
        while True:
            try:
